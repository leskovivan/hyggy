    ...
    <div className="review-modal-overlay" onClick={onClose}>
      <div className="review-modal-card" onClick={e => e.stopPropagation()}>
        ...
        <form className="review-modal-form" onSubmit={handleFormSubmit}>
          <input type="text" placeholder="Тема*" required value={formData.subject} onChange={e => setFormData({...formData, subject: e.target.value})} />
          ...
          <textarea placeholder="Відгук*" required value={formData.comment} onChange={e => setFormData({...formData, comment: e.target.value})} />
