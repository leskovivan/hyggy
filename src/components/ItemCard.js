...
const ItemCard = ({ product }) => {
  ...
  const handleFavoriteClick = (e) => {
    ...
    if (!user) {
      alert('Тільки зареєстровані користувачів можуть додавати товари в обране!');
      navigate('/login');
      return;
    }
      ...
      <div className="item-card">
        <div className="item-card__image-box">
          ...
          <div className="item-card__badges">
            {/* Використовуємо discount замість oldPrice для перевірки */}
        ...
        <div className="item-card__info">
          ...
          <div className="item-card__prices">
            <div className="price-current">{currentPrice}$<span className="price-unit">/шт.</span></div>
            {/* Показуємо вирахувану стару ціну */}
            {oldPrice && <div className="price-old">{oldPrice}$</div>}
          </div>
